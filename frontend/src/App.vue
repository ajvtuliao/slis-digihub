<template>
  <v-app style="background: rgba(252, 239, 192, 0.5)">
      ...
      >
        ...
        <v-col cols="5" class="mt-3 ml-2">
          <v-row align="center">
            ...
            <v-btn class="mx-n1" text color="#faf4e6" @click="goToCollection">
              Collections
            </v-btn>
            <v-btn class="mx-n1" text color="#faf4e6" @click="goToAbout">
              About
            </v-btn>
              ...
              <v-list color="rgb(255, 204, 0)" dense>
                <v-list-item-group>
                  <v-list-item
                    ...
                    :href="'https://upslis.info/'"
                  >
                    <v-list-item-title>UP SLIS Website</v-list-item-title>
                  </v-list-item>
                  <v-list-item
                    class="font-weight-bold"
                    :href="'https://digitalarchives.upd.edu.ph'"
                  >
                    <v-list-item-title>UPD Digital Archives</v-list-item-title>
                  </v-list-item>
                  <v-list-item
                    class="font-weight-bold"
                    :href="'https://ds.mainlib.upd.edu.ph/'"
                  >
                    <v-list-item-title> UPD Tuklas</v-list-item-title>
                  </v-list-item>
                  <v-list-item
                    class="font-weight-bold"
                    :href="'https://mainlib.upd.edu.ph/online-subscriptions'"
                  >
                    <v-list-item-title
                      >UL Online Subscriptions</v-list-item-title
                    >
                  </v-list-item>
                  <v-list-item
                    class="font-weight-bold"
                    :href="' https://ipp.mainlib.upd.edu.ph'"
                  >
                    <v-list-item-title
                      >Index to Philippine Periodicals</v-list-item-title
                    >
                  </v-list-item>
                  <v-list-item
                    class="font-weight-bold"
                    :href="'https://ipn.mainlib.upd.edu.ph'"
                  >
                    <v-list-item-title
                      >Index to Philippine Newspapers</v-list-item-title
                    >
                  </v-list-item>
                </v-list-item-group>
              </v-list>
            ...
            <div v-if="this.loggedIn == false" :key="this.loggedIn">
              <v-dialog v-model="dialog" max-width="43em" max-height="120em">
                <template v-slot:activator="{ on, attrs }">
                ...
                <v-card dark>
                  <v-spacer>
                    <h1 class="text-center font-weight-bold pt-7">
                      Admin Login
                    </h1>
    ...
    <v-footer dark padless>
      <v-card class="text-center" flat tile width="100%" color="#1e2328">
        <v-card-text>
          <v-btn
            icon
            dark
        ...
        <v-card-text class="mt-n4 text-muted">
          <i> UP School of Library and Information Studies Library</i> —
